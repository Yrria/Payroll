...
(5, 5, 13, 5, 80, 0, 0, 1, 'Late', '2025-05-13'),
...
INSERT INTO `tbl_salary` (`salary_id`, `emp_id`, `l_name`, `f_name`, `m_name`, `position_name`, `emp_shift`, `year`, `month`, `cutoff`, `status`, `basic_pay`, `holiday_pay`, `ot_pay`, `pagibig_deduction`, `philhealth_deduction`, `sss_deduction`, `other_deduction`, `total_salary`) VALUES
(1, 1, 'Toledo', 'Marc Andrei', 'Andrei', 'Service Crew', 'Night', 2025, 'May', 'First Cutoff', 'Paid', 30000, 4000, 0, 750, 675, 300, 3725, 9275),
(2, 2, 'Lofamia', 'Dhaniel', 'Dela Cruz', 'Service Crew', 'Day', 2025, 'May', 'Second Cutoff', 'Paid', 15600, 2080, 0, 390, 351, 156, 1897, 5383);
...
--
ALTER TABLE `tbl_salary`
  MODIFY `salary_id` int(100) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=10;
