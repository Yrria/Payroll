...
--
-- Host: 127.0.0.1
-- Generation Time: May 11, 2025 at 04:13 PM
...
(7, 7, 12, 3, 96, 0, 0, 2, 'Late', '2025-05-11');
...
(7, 1, 'MAY CANCER AKO', '2025-05-11', '2025-05-18', '2025-05-22', 'Medical Leave', 'LEAVE MUNA KO MAY TUMOR NAKO SA UTAK PA-CHEMO THERAPY LANG AKO MGA 4 DAYS', 'Pending', '', 0, NULL, NULL),
...
INSERT INTO `tbl_salary` (`salary_id`, `emp_id`, `l_name`, `f_name`, `m_name`, `position_name`, `emp_shift`, `year`, `month`, `cutoff`, `status`, `basic_pay`, `holiday_pay`, `ot_pay`, `pagibig_deduction`, `philhealth_deduction`, `sss_deduction`, `other_dedution`, `total_salary`) VALUES
(1, 1, 'Toledo', 'Marc Andrei', 'Andrei', 'Service Crew', 'Night', 2024, 'January', 'First Cutoff', 'Unpaid', 30000, 500, 500, 500, 500, 500, 500, NULL),
(2, 2, 'Lofamia', 'Dhaniel', 'Dela Cruz', 'Service Crew', 'Day', 2024, 'January', 'Second Cutoff', 'Unpaid', 30000, 500, 500, 500, 500, 500, 500, NULL);
...
--
ALTER TABLE `tbl_leave`
  MODIFY `leave_id` int(100) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=58;
