...
--
-- Host: 127.0.0.1
-- Generation Time: Mar 24, 2025 at 12:02 PM
...
INSERT INTO `emp_acc` (`id`, `emp_id`, `password`, `email`, `fname`, `mname`, `lname`, `status`, `otp`) VALUES
(1, 'emp0001', 'emp0001', 'fidelisalen@gmail.com', 'Marc', 'A', 'Toledo', 'inactive', 256389);
...
(1, 'toledo', 'marc andrei', 'kalapati', 'ic.marcandrei.toledo@cvsu.edu.ph', 'kalapati', 'habay, bacoor', 99123456789, 'male', 0);
