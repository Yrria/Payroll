...
--
-- Host: 127.0.0.1
-- Generation Time: Jun 09, 2025 at 02:52 AM
...
(1, 1, 'Morning', 'Manager', 123456789, '?', 720),
(2, 2, 'Morning', 'Manager', 98765432123, 'Cash', 520),
...
--
ALTER TABLE `tbl_emp_acc`
  MODIFY `emp_id` int(100) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=25;
