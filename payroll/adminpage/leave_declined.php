...
$sql = "SELECT * FROM tbl_leave WHERE status = 'Declined'";
    ...
    <div id="mainContent" class="main">
      <div class="head-title">
        ...
        <div class="breadcrumb">
          ...
          <span> > </span>
          <h5><a href="./leave_declined.php">Leave-Declined </a></h5>
        </div>
        <hr>
      </div>
...
<script>
  ...
  const closeModalButtons = document.querySelectorAll(".close-info");
  ...
  document.getElementById('search_emp_input').addEventListener('keyup', function () {
    ...
    let status = 'Declined'; // This will be for the declined page.
  ...
  let successMess = '<i class="fa-solid fa-circle-check"></i>Leave declined successful!';
