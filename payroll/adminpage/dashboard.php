          ...
          <div class="content">
            ...
            <div class="Event">
              <div class="Event-header" style="position: relative;">
                ...
                <!-- Replaced "View All" text with an icon -->
                <a href="#" class="view-all-icon" onclick="openViewAllModal()" title="View All" style="position: absolute; top: 0; right: 0;">
            ...
            <div id="eventModal" class="modal">
              <div class="modal-content">
                ...
                <form id="eventForm">
                  ...
                  <button type="submit" class="add-event-btn" title="Add Event">
            ...
            <div class="leave-requests">
              ...
              <a href="leave_pending.php" id="view-all-btn2" class="view-all-icon" title="View All">
                <i class="fa-solid fa-expand"></i>
              </a>
