...
--
-- Host: 127.0.0.1
-- Generation Time: Jun 07, 2025 at 08:32 AM
...
INSERT INTO `tbl_emp_acc` (`emp_id`, `lastname`, `firstname`, `middlename`, `email`, `password`, `address`, `phone_no`, `gender`, `status`, `otp`, `photo_path`) VALUES
(1, 'Toledo', 'Marc Andrei', 'Andrei', 'ic.marcandrei.toledo@cvsu.edu.ph', 'pass', 'habay, bacoor', 99123456789, 'male', 'active', 0, NULL),
(2, 'Lofamia', 'Dhaniel', 'Dela Cruz', 'dhanieeel0907@gmail.com', 'pass', 'jan lang', 937383717, 'Male', 'active', 0, NULL),
(3, 'Valentino', 'Martin', 'Malapo', 'ic.martinlouis.valentino@cvsu.edu.ph', 'pass', 'malumot,panapaan bacolor city', 9924210601, 'Male', 'active', 0, NULL),
(4, 'Fidelis', 'Alen', 'Nicanor', 'ic.alen.fidelis@cvsu.edu.ph', 'pass', 'dexterville sabang', 9924210601, 'Male', 'active', 0, NULL),
(5, 'Carlos', 'Nicol', 'Obes', 'ic.carlosjr.nicol@cvsu.edu.ph', 'pass', 'panapaan', 9924210601, 'Male', 'active', 0, NULL),
(6, 'Macaspac', 'Patrick', 'Pitalco', 'ic.johnpatrick.macaspac@cvsu.edu.ph', 'pass', 'carbag', 9924210601, 'Male', 'active', 0, NULL),
(7, 'Javier', 'Harvey', 'Camacho', 'ic.harvey.havier@cvsu.edu.ph', 'pass', 'binakayan', 9924210601, 'Male', 'active', 0, NULL),
(16, '', '', NULL, 'toledomarcandrei385@gmail.com', 'pass', NULL, NULL, NULL, '', NULL, 'User.16.1.jpg');
...
(1, 1, 'Toledo', 'Marc Andrei', 'Andrei', 'Service Crew', 'Night', 2025, 'June', 'First Cutoff', 'Unpaid', 30000, 4000, 0, 750, 675, 300, 200, 11275, 11075),
(2, 2, 'Lofamia', 'Dhaniel', 'Dela Cruz', 'Service Crew', 'Morning', 2025, 'June', 'Second Cutoff', 'Paid', 15600, 0, 0, 390, 351, 156, 200, 5863, 5663),
(22, 5, 'Carlos', 'Nicol', 'Obes', 'Crew', 'Morning', 2025, 'June', 'First Cutoff', 'Unpaid', 520, 0, 0, 0, 0, 0, 0, 520, 520),
(23, 4, 'Fidelis', 'Alen', 'Nicanor', 'Manager', 'Morning', 2025, 'June', 'First Cutoff', 'Unpaid', 720, 0, 0, 0, 0, 0, 0, 720, 720);
...
--
ALTER TABLE `tbl_attendance`
  MODIFY `attendance_id` int(100) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=29;
...
--
ALTER TABLE `tbl_salary`
  MODIFY `salary_id` int(100) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=24;
